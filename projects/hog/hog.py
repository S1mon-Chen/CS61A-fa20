...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while True:
        if who == 0:
            num_rools = strategy0(score0, score1)
            score0 += take_turn(num_rools, score1, dice)
            ...
            num_rools = strategy1(score1, score0)
            score1 += take_turn(num_rools, score0, dice)
            say = say(score0, score1)
            if score1 >= goal:
                break
...
def make_averaged(original_function, trials_count=1000):
    ...
    def averaged_function(*args):
        ...
        while i < trials_count:
            sum_of_results += original_function(*args)
            i += 1
        return sum_of_results / trials_count
